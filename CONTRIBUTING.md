# Contributing to REACT COOL PORTAL

When contributing to this repository, please first discuss the change you wish to make via issue, email, or any other method with the owners of this repository before making a change.

Please note we have a [code of conduct](https://github.com/wellyshen/react-cool-portal/blob/master/CODE_OF_CONDUCT.md), please follow it in all your interactions with the project.
...
5. Update the [README.md](https://github.com/wellyshen/react-cool-portal/blob/master/README.md) with details of changes to the interface.
6. Update the [demo app](https://github.com/wellyshen/react-cool-portal/tree/master/demo/App) if needed.
...
After cloning REACT COOL PORTAL, run `yarn` to fetch its dependencies. Then, you can run several commands:

- `yarn dev` runs the [demo app](https://github.com/wellyshen/react-cool-portal/tree/master/demo/App) as your playground at `localhost:10001`. Support live reloading.
...
By contributing to REACT COOL PORTAL, you agree that your contributions will be licensed under its MIT license.
